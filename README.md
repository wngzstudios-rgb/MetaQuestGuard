...
**Standalone anti-cheat for Meta Quest VR games.**  
Built on Meta Attestation, identity, and entitlement — not PC kernel drivers or third-party cloud scanners.
...
[![License](https://img.shields.io/badge/License-Commercial-red?style=flat-square)](#license--access)

> Official product site & docs live in this repo.  
> **Shipping builds use an obfuscated DLL** (ConfuserEx / Obfuscar / commercial IL obfuscator + string encryption). Source is available to licensed studios.
...
- **Netcode-agnostic core** — Mirror bridge ships today; Photon helpers included; Fusion / others follow the same pattern.
...
| **Runtime scans** | Mod loaders, Harmony graphs, injected libs, unusual `libunity`/`libil2cpp` maps, dynamic codegen, debuggers, emulator signals |
...
**Commercial product.** Shipping builds are distributed as an **obfuscated DLL**.  

- Licensed studios receive the obfuscated package and integration support.  
- Source access is available under studio agreement.  
- Do not redistribute the paid package or source without a license.

For licensing and the paid package, contact the author via the channels listed on the product page (`MetaQuestGuard.html`).

---

## Disclaimer

No anti-cheat is perfect. Determined attackers with full client control can still attempt bypasses. MetaQuestGuard raises attacker cost, binds sessions to Meta-verified identity and device integrity, and moves competitive outcomes to a server-authoritative boundary — the same layered approach Meta and Photon document. Always pair with strong server authority, proportional enforcement, and a clear appeals path.

---

<p align="center">
  <strong>MetaQuestGuard</strong> · Standalone · Attestation-native · GorillaLocomotion-aware<br/>
